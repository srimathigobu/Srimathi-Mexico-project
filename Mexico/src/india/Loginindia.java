...
public class Loginindia {
	...
	public static void main(String[] args) throws InterruptedException {
		// TODO Auto-generated method stub
				...
				WebDriverWait z = new WebDriverWait(driver, Duration.ofSeconds(15));
...
//			Thread.sleep(3000);
				...
				//driver.findElement(By.xpath("//input[@placeholder='Ingresa tu correo electrónico']")).sendKeys("akilanuday26@gmail.com");
				driver.findElement(By.xpath("//input[@name='password']")).sendKeys("Aksriyash@2022");
				//driver.findElement(By.xpath("//input[@placeholder='Ingresa tu contraseña']")).sendKeys("Aksriyash@2022");
...
//				driver.findElement(By.cssSelector("a[class='btn btn-primary']")).isDisplayed())
...
//				driver.findElement(By.id("*[id^='phone-'][id$='_phone_number']")).click();
				...
				driver.findElement(By.cssSelector("*[id^='phone-'][id$='_phone_number']")).sendKeys("09442045843");
